...
document.getElementById("txtRouge").innerHTML = red_text
document.getElementById("txtBleu").innerHTML = blue_text
document.getElementById("logoSRV").setAttribute("src", "Assets/IMG/" + img)
document.getElementById("DiscordLink").setAttribute("href", Discord_link)
document.getElementById("DiscordLink").innerHTML = DiscordLink

if (mp3_player === true) {
	document.getElementById("YTvdo").setAttribute("src", "https://www.youtube.com/embed/" + video_ID + "?autoplay=1&mute=1&loop=1&showinfo=0&rel=0&iv_load_policy=3&fs=0&controls=0&start=" + start)
} else if (mp3_player === false) {
	document.getElementById("YTvdo").setAttribute("src", "https://www.youtube.com/embed/" + video_ID + "?autoplay=1&mute=0&loop=1&showinfo=0&rel=0&iv_load_policy=3&fs=0&controls=0&start=" + start)
